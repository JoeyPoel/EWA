...
values ('inventoryorder 1', '2023-01-01', '2023-01-10', 1, 1),
       ('inventoryorder 2', '2023-02-01', '2023-02-10', 1, 2),
       ('inventoryorder 3', '2023-03-01', '2023-03-10', 2, 3),
       ('inventoryorder 4', '2023-04-01', '2023-04-10', 2, 4),
       ('inventoryorder 5', '2023-05-01', '2023-05-10', 3, 5),
       ('inventoryorder 6', '2023-06-01', '2023-06-10', 3, 6),
       ('inventoryorder 7', '2023-07-01', '2023-07-10', 4, 7),
       ('inventoryorder 8', '2023-08-01', '2023-08-10', 4, 8),
       ('inventoryorder 9', '2023-07-01', '2023-07-10', 1, 9),
       ('inventoryorder 10', '2023-07-15', '2023-07-25', 1, 10),
       ('inventoryorder 11', '2023-07-30', '2023-08-09', 2, 11),
       ('inventoryorder 12', '2023-08-14', '2023-08-24', 2, 12),
       ('inventoryorder 13', '2023-08-29', '2023-09-08', 3, 13),
       ('inventoryorder 14', '2023-09-13', '2023-09-23', 3, 14),
       ('inventoryorder 15', '2023-09-28', '2023-10-08', 4, 15),
       ('inventoryorder 16', '2023-10-13', '2023-10-23', 4, 16),
       ('inventoryorder 17', '2023-10-28', '2023-11-07', 1, 17),
       ('inventoryorder 18', '2023-11-12', '2023-11-22', 1, 18),
       ('inventoryorder 19', '2023-12-03', '2023-12-13', 2, 19),
       ('inventoryorder 20', '2024-01-20', '2024-01-30', 3, 20),
       ('inventoryorder 21', '2023-12-18', '2023-12-28', 4, 21),
       ('inventoryorder 22', '2024-01-04', '2024-01-14', 1, 22),
       ('inventoryorder 23', '2024-01-19', '2024-01-29', 2, 23),
       ('inventoryorder 24', '2024-02-03', '2024-02-13', 3, 24),
       ('inventoryorder 25', '2024-02-18', '2024-02-28', 4, 25),
       ('inventoryorder 26', '2023-12-13', '2023-12-23', 4, 26),
       ('inventoryorder 27', '2024-01-08', '2024-01-18', 1, 27),
       ('inventoryorder 28', '2024-01-13', '2024-01-23', 2, 28),
       ('inventoryorder 29', '2024-02-08', '2024-02-18', 3, 29),
       ('inventoryorder 30', '2024-02-23', '2024-03-05', 4, 30);
